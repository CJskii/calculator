...
Basic HTML calculator with buttons for each digit, each of the above functions and an “Equals” key.

    - display for the calculator
    - clear button
    - display will populate numbers when number buttons are clicked
    - display variable is stored in the code


// ORIGINAL ASSIGMENT TEXT // 
